#!/usr/bin/env python3
"""Full fine-tune 原图 500张/种 — us-east-1"""
...
S3_CHECKPOINT_URI = f"s3://{S3_BUCKET}/checkpoints/full-ft-original"
INSTANCE_TYPE = "ml.p3.2xlarge"
TRAINING_IMAGE = "763104351884.dkr.ecr.us-east-1.amazonaws.com/pytorch-training:2.0.1-gpu-py310"
JOB_NAME_PREFIX = "dinov2-full-ft-original"
...
def package_and_upload():
    ...
    s3.upload_file(p, S3_BUCKET, "code/sourcedir-ft-original.tar.gz")
    os.unlink(p)
    return f"s3://{S3_BUCKET}/code/sourcedir-ft-original.tar.gz"

def main():
    print(f"Full fine-tune 原图 — {REGION}")
