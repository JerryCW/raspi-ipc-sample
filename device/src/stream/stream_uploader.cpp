...
// Format: comma-separated key=value (used by StreamUploader for direct kvssink config)
// "iot-thing-name=xxx,endpoint=xxx,cert-path=xxx,key-path=xxx,ca-path=xxx,role-aliases=xxx"
// NOTE: GStreamerPipeline sets iot-certificate inline in the parse string
// using GstStructure serialization format instead.
// ============================================================
